defmodule Mix.Tasks.Tq2.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix tq2.gen.html Accounts User users name:string age:integer
  ...
  with their respective names and types. See `mix tq2.gen.schema`
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix tq2.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix tq2.gen.html Sales User users --web Sales
  ...
  use binary ids for primary keys, see `mix tq2.gen.schema` for more
  information.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix tq2.gen.html must be invoked from within your *_web application root directory"
      )
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/tq2.gen.html", binding, files)
